                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      GestureDetector(onTap: () => controller.onTapSkipAndBrowse(), child: const SizedBox(height: 80,child: Padding(padding: EdgeInsets.symmetric(vertical: 20), child: Text("Skip and Browse"),),),),
                    ],
                  ),
                ),
              ),
